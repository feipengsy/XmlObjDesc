      ...
      while True:
        if 'typename' in attTypeList[0]:
          if attTypeList[0]['attrs']['extern'] == 'TRUE':
            ...
            if templateType not in templateDict:
